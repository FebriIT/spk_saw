            ...
            <div class="col-md-12 card-deck mt-3">
                <div class="card mb-3">
                    <div class="card-header">
                        <h3 class="float-left">Tabel Normalisasi</h3>
                        <a href="{{route('perhitungan')}}" class="btn btn-success btn-sm mr-3 mb-2 float-end text-white"> <i class="fa fa-eye"></i> Tabel Hasil Analisa</a>
                    </div>
