            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <form class="form-horizontal form-material" action="/profile/update/{{auth()->user()->id}}" method="POST">
                                    @csrf
                                    ...
                                    <div class="form-group mb-4">
                                        <div class="col-sm-12">
                                            ...
                                            <a class="btn btn-primary" href="/ganti-password" role="button">Ganti Password</a>
                                        </div>
                                    </div>
                                </form>
